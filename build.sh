...
if [ ! -d $CLANG_DIR ]; then
    ...
    git clone https://github.com/kdrag0n/proton-clang ../pclang --depth 1
fi
...
move_files() {
echo -e "${blue}Moving Files${nocol}"
...
upload_gdrive() {
gdrive upload -p 1yObApxbU_y58aiQWK7cTnU1DQeS_OkXh ${KERNELZIP}
}
